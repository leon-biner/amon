...
def create_parser(run_f, windrose_f, show_terrain_f, show_turbine_f, server_start_f, server_stop_f):
    ...
    parser_terrain = subparsers.add_parser("show-terrain", help="\033[94mDisplay terrain\033[0m")
    parser_terrain.add_argument("zone_id", type=int, metavar="ZONE_ID", help="\033[94mId of the zone\033[0m")
