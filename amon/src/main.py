...
def _showWindrose(args):
    ...
    print("Showing windrose ", end='')
    '''
    if args.s:
        print("from server")
        from client import showWindroseRequest
        print(showWindroseRequest(args))
    else:
        print("locally")
    '''
...
def _showTerrain(args):
    ...
    print("Showing terrain ", end='')
    '''
    if args.s:
        print("from server")
        from client import showTerrainRequest
        print(showTerrainRequest(args))
    else:
        print("locally")
    '''
